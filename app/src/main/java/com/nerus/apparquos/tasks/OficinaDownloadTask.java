...
public class OficinaDownloadTask extends AsyncTask<String, Integer, Object> {
    public static final String TASK_NAME="OficinaDownloadTask";
    ...
    public OficinaDownloadTask(String urlApi, String tokenApp, String tokenUser, CausaNoEjecucionDAO objectDAO) {
        super();
        mUrlApi=urlApi;
        mTokenApp=tokenApp;
    ...
    public OficinaDownloadTask setCallBacks(TasksCallBacks callBacks) {
                ...
                if (jsonResult.has("data") == true) {
                    try {
                        ...
                        for (Integer i = 0; i < jArray.length(); i++) {
                            ...
                            CausaNoEjecucion content = new CausaNoEjecucion(oneObject.getInt("id_anomalia")
