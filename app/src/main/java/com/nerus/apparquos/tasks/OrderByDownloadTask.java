...
public class OrderByDownloadTask extends AsyncTask<String, Integer, Object> {
    public static final String TASK_NAME="OrderByDownloadTask";
    private TasksCallBacks mCallBacks;
    private String mUrlApi;
    private String mTokenApp;
    private String mTokenUser;
    private List<OrderBy> mObjectToReturn;
    public OrderByDownloadTask(String urlApi, String tokenApp, String tokenUser) {
        super();
        mUrlApi=urlApi;
        mTokenApp=tokenApp;
    ...
    public OrderByDownloadTask setCallBacks(TasksCallBacks callBacks) {
    ...
    protected Object doInBackground(String... values) {
        String url = mUrlApi + "/lecturas_orderby/";
            ...
            try {
                ...
                if (jsonResult.has("data") == true) {
                    try {
                        ...
                        OrderBy hintContent = new OrderBy(-1, "-- SIN ESPECIFICAR --");
                        ...
                        for (Integer i = 0; i < jArray.length(); i++) {
                            ...
                            OrderBy content = new OrderBy(oneObject.getInt("id_order")
