...
public class CausasDownloadTask extends AsyncTask<String, Integer, Object> {
    public static final String TASK_NAME="CausasDownloadTask";
    private TasksCallBacks mCallBacks;
    private String mUrlApi;
    private String mTokenApp;
    private String mTokenUser;
    private CausaNoEjecucionDAO mAsyncObjectDAO;
    public CausasDownloadTask(String urlApi, String tokenApp, String tokenUser, CausaNoEjecucionDAO objectDAO) {
        super();
        mUrlApi=urlApi;
        mTokenApp=tokenApp;
    ...
    public CausasDownloadTask setCallBacks(TasksCallBacks callBacks) {
    ...
    protected Object doInBackground(String... values) {
        String url = mUrlApi + "/causasnoejecucion/";
            ...
            try {
                ...
                if (jsonResult.has("data") == true) {
                    try {
                        ...
                        CausaNoEjecucion hintContent = new CausaNoEjecucion(-1, "-- SIN ESPECIFICAR --","",false );
                        //mAsyncObjectDAO.insert(hintContent);
                        List<CausaNoEjecucion> list = new ArrayList();
                        ...
                        for (Integer i = 0; i < jArray.length(); i++) {
                            ...
                            CausaNoEjecucion content = new CausaNoEjecucion(oneObject.getInt("id_causa")
