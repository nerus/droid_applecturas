...
public class LecturaUpdateTask extends AsyncTask<Lectura, Integer, Object> {
    public static final String TASK_NAME="LecturaUpdateTask";
    private TasksCallBacks mCallBacks;
    private LecturaDAO mAsyncObjectDAO;
    public LecturaUpdateTask(LecturaDAO objectDAO) {
        super();
        mAsyncObjectDAO = objectDAO;
    }

    public LecturaUpdateTask setCallBacks(TasksCallBacks callBacks) {
    ...
    protected Object doInBackground(Lectura... values) {
        ...
        mAsyncObjectDAO.update(lectura);
        return "OK";
    }
