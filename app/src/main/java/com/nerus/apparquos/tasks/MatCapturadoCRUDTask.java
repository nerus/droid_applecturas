...
public class MatCapturadoCRUDTask extends AsyncTask<MaterialCapturado, Integer, Object> {
    public static final String TASK_NAME="MatCapturadoCRUDTask";
    private TasksCallBacks mCallBacks;
    private MaterialCapturadoDAO mAsyncObjectDAO;
    private String mAction;
    public MatCapturadoCRUDTask(MaterialCapturadoDAO objectDAO, String action) {
        super();
        mAsyncObjectDAO = objectDAO;
        mAction=action;
    }

    public MatCapturadoCRUDTask setCallBacks(TasksCallBacks callBacks) {
    ...
    protected Object doInBackground(MaterialCapturado... values) {
        MaterialCapturado item = (MaterialCapturado) values[0];
