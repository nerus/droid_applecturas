...
public class LecturaInsertTask extends AsyncTask<Lectura, Integer, Object> {
    public static final String TASK_NAME="LecturaInsertTask";
    private TasksCallBacks mCallBacks;
    private LecturaDAO mAsyncObjectDAO;
    public LecturaInsertTask(LecturaDAO objectDAO) {
        super();
        mAsyncObjectDAO = objectDAO;
    }

    public LecturaInsertTask setCallBacks(TasksCallBacks callBacks) {
    ...
    protected Object doInBackground(Lectura... values) {
        Lectura lectura = (Lectura) values[0];
        mAsyncObjectDAO.insert(lectura);
        return "OK";
    }
