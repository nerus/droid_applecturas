...
public class UsuarioDeleteTask extends AsyncTask<Usuario, Integer, Object> {
    public static final String TASK_NAME="UsuarioDeleteTask";
    private TasksCallBacks mCallBacks;
    private UsuarioDAO mAsyncObjectDAO;
    public UsuarioDeleteTask(UsuarioDAO objectDAO) {
        super();
        mAsyncObjectDAO = objectDAO;
    }

    public UsuarioDeleteTask setCallBacks(TasksCallBacks callBacks) {
        mCallBacks = callBacks;
        return this;
    }

    @Override
    protected Object doInBackground(Usuario... values) {
