...
public class ParametroInsertTask extends AsyncTask<Parametro, Integer, Object> {
    public static final String TASK_NAME="ParametroInsertTask";
    private TasksCallBacks mCallBacks;
    private ParametroDAO mAsyncObjectDAO;
    private Parametro parametroSaved;
    public ParametroInsertTask(ParametroDAO objectDAO) {
        super();
        mAsyncObjectDAO = objectDAO;
    }

    public ParametroInsertTask setCallBacks(TasksCallBacks callBacks) {
